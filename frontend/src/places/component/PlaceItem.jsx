...
const PlaceItem = (props) => {
  return (
    <li className='place-item p-4 w-[300px] bg-white hover:bg-amber-50 shadow-md rounded-lg hover:shadow-lg transition-shadow duration-300 m-auto mb-4'>
      ...
      <div className="place-item__actions mt-4 flex space-x-2">
        <button className='flex-1 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors duration-300'>
          VIEW ON MAP
        </button>
        <button className='flex-1 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors duration-300'>
          EDIT PLACE
        </button>
